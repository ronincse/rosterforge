...
> Historical gap observations are superseded in scoped channels by SC-01/02 and
> SC-03/07 below. In particular Gas210/default200 is now a known budget violation;
> seven source-zero default activations remain explicitly unresolved.
...
at69b2095, other worktrees/origins preserved. Storage delegate commit38a55327
was reviewed and integrated as8a38e999d7f134e8b3327c25ec9d324b88ef927c.
Lead evaluation/controls/QA commitac112e91a0c6b511cfaebb5ddca4798a55856984;
this documentation-only handoff is separate. Publish these own commits together
only after gates, so no incomplete integration is presented as accepted support.

**Evidence and decision.** Pinned nr-editor028526ee2bce36ce26f024e33d762ab9f257445b
explicitly labels defaultCostLimit -1 as No limit and defines exact limit::ID query
fields. After an initial automatic review block, the owner explicitly authorized
all New Recruit usage. Moving NR StarCraft catalogue13/GST12 observed Gas30:
committed limit10 ->20too many; explicit0 ->30too many; -1 ->no budget error.
Fresh creation2000Minerals/200Gas and positive signed counters without max0 errors
were observed. This is not exact immutable closure parity. Source-zero and hidden
activation remain confounded; a fictional directory import could not use the
available browser file chooser, so no generalized interpretation was invented.
Positive finite creation-visible defaults are supported; source-1 unbounded;
missing/exact-empty absent; malformed nonempty invalid; source-zero/hidden-positive
activation unresolved. Explicit player0/-1 is supported regardless of visibility,
with identity ambiguity/dynamic behavior still withheld. No names, whitespace,
positive-only purchase classification or Minerals-to-Gas ratio enters semantics.

**Implementation.** Headless effective-limit resolver reads immutable saved roster
configuration/source context only. Supported roster/any/shared numeric limit::ID
leaves read it; cost evaluation consumes conditions; budget validation then reads
evaluated per-currency costs. No recursive limit/cost dependency or signed unknown
subtotal lower-bound inference. Orphan uncertainty stays with the relevant currency.
Independent force/category restrictions coexist, including tighter40k capacity;
no numeric coincidence is used to deduplicate distinct source requirements.
Unknown behavior envelopes/cycles remain incomplete. Mandatory validation budget
input and context guards prevent omitted or foreign evidence from yielding success.

Exact-ID overrides validate finite nonnegative values or -1, rejecting malformed
records, duplicates, invalid IDs and present/past/future snapshot corruption.
Reset removes the override, preserving source bytes and selection identities.
No reconciliation discards selected maps when their choices become hidden.
Immutable commands use ordinary history, autosave, save/open and recovery; source
bytes are not copied on an edit. UI shows independent totals/limits and only exact
remaining/over amounts, with source/override labels and explicit Apply/reset.
Blank unfinished input never commits0. Existing per-currency qualifications remain.

**Browser acceptance.** Fresh5275 origin, ordinary Browse/load/create for all three.
Protoss Daelaam+sevenForges Gas210/200 is invalid/incomplete with one budget finding;
override210 repairs that finding and reset restores it. Undo/redo, saved override
reopen and saved reset reopen pass. Minerals2000 ->1000 changes actual Deployment
Maps from Acropolis set to Abandoned Camp set; reset2000 restores available choices
while retaining selected Abandoned Camp. Gas remains independent. Terran Armed
Forces+Marines160/override100 yields60over, Gas0/200 unchanged; a fresh same-origin
tab offered Recover roster and restored the unsaved100 override,160 total and
violation, then saved normally. This is new-tab recovery, not a claimed reload
through the original unsaved-navigation guard. Zerg Swarm+twelve-model Zerglings
180/Core2 with Minerals180 is satisfied; each army retains independent limits.
Current Protoss reopens with default2000/200 and known Gas210 violation.
Desktop1440x900,390x844,focused320x844 screenshots inspected; at320 client/scroll
width305/305, no horizontal page overflow. Phone problem dialog readable after
animation; close focus returns to trigger. Keyboard Apply and reset-input focus
verified. Final console warnings/errors empty. No physical-device/screen-reader/
full-game/full40k browser claim. Four screenshots and full-suite log remain in
local visualization evidence; report names them. Leave5275 server running.

**Tests, corpus and review.** Full suite818pass31optionalSkip,85pass7skipfiles,
25.46s. Configured28pass4files/no skips52.22s,27existing40k+1expandedStarCraft.
40kHEAD04c62fcd041b3808c39d5c46fd677c704027b979 and correctness A/B manifests
unchanged. StarCraft99261754e0449bbaaa04e6890e1625b144f9ece1 and four SHA256
hashes execute unchanged; GST500146, Terran112172, Protoss92542, Zerg134299 bytes.
Gas210/default200/override/reset and actual dm00 leaf2000/1000/reset pass;
seven source-zero limits unresolved without invented budget violations.
Accepted SC01/SC02 findings retain validity; their former complete assertions
now appropriately include the seven unknown default activations. Reinforced
Marines remains six/230, then180 after removal; no SC04 repair implied.

18 fictional resource tests plus style/composition focus34pass3files1.13s;
real App UI regression1pass1file3.82s after removal of three unsupported Testing
Library type options. Storage lane104pass2files then included in full lead suite.
Earlier LF-sensitive style failures fixed by restoring LF before full suite.
Final lint/typecheck/build/diff pass;188modules,JS831.83kB/gzip230.28,
CSS83.38kB/gzip14.87, existing chunk advisory. Renderer timing, phone reference,
persistence/history/recovery, reference pricing, supporting/connected, structural/
category/force, conditional initialization and orphan-cost regressions remain green.

Lead retained evaluator, integration, UI, QA and publication; one isolated native
storage writer and one isolated native semantic/candidate reviewer supplied useful
non-overlapping work. Claude scoped read-only launch unavailable (access denied);
no retry/install/billing changes and no external approval claim. Reviewer identified
unknown behavior-envelope refusal, foreign cost report incompleteness even when
all limits inactive, and missing budget finding count; corrected with regressions.
Final independent candidate review approved all three fixes with no blockers.

**Remaining and stop.** Source-default zero/hidden-positive activation and dynamic
limits have a separate roadmap row; unsupported queries remain incomplete. The
nine40k category-owned force/cost bounds remain independently unresolved. SC04
reinforcement, SC05 XML entities, SC06 profile metadata and SC08 freshness remain
open, as do unsupported mission/default-group semantics. No full legality or data
closure parity claim. Architecture/compatibility/diagnostics and focused QA updated;
...
## Completed Assignment — 2026-09-14: SC-05 XML reference values (B)

**Baseline and result.** Baseline4962ece84ffb6891aac8e99248675807edd096ee was
clean and upstream-equal after fetch. Implementation/tests/evidence:
887b3769bb98a642b60c022233a8c4bf7cab2417; this separate handoff follows. A was
completed and published first as fa8ea58 +4962ece, with CI34920532400 green.
No concurrent writer or reset of newer work; main and UI checkouts preserved.

**Decision.** Frozen99261754 contains escaped Raynor name attributes and C14/
Protoss characteristic text. Fictional ingestion/projection tests reproduced
35 failures and6 passes before the fix. Fresh5279 browser reproduced the escaped
faction and Marine12-inch text and saved a disposable pre-repair army. Installed
fast-xml-parser5.8.0, its source/options/validator and W3C XML1.0 were inspected.
Enabling general processing alone did not meet the numeric/reference contract.
Kept processEntities:false; explicit CDATA context plus an internal XML-only
adapter decodes ordinary text/attributes during ordered-node conversion.

Exactly five predefined entities and valid decimal/hex XML1.0 Char references
decode once. Output ampersands are never scanned again. CDATA/comments/PI payloads
bypass decoding. Reference spellings have an explicit36-character resource bound.
Malformed/unsupported references fail BS_XML_REFERENCE_INVALID or the earlier
syntax diagnostic; character ranges are checked before character creation.
Rejected dependency upgrades, raw XML replacement, HTML vocabulary/decoders,
per-game fixes and decoding persisted/player text. Existing whitespace and PI
representation remain; no new full XML conformance claim.

**Security and compatibility.** Original archive/source/document bytes, hashes,
locations, immutable keys and archive size/path/bounded-inflate/CRC protections
are unchanged. The declaration precheck remains, including conservative rejection
inside comments/CDATA. Custom/external/parameter entities remain prohibited.
Maintainer advisories informed small regressions, not an installed-vulnerability
claim. Actual React reference rendering keeps encoded dangerous-looking text
inert while retaining allowed formatting. No new HTML/regex execution privilege.

Derived metadata payload3 ->4 rebuilds older summaries from verified cached bytes
without clearing byte caches or drafts. Legacy XML ID spelling matches only the
same source/path/kind in restore and structural checks. Three fictional saved
source/history round trips preserve bytes, IDs, names and budget behavior; new
add/remove still works and wrong identity fails. Saved source-fallback and player
names are indistinguishable, so copied escapes remain unchanged. Legacy escaped
budget IDs lack path evidence and remain unresolved. Both limits are in the
roadmap. All four frozen StarCraft files have no escaped IDs, so its identities
and budgets need no alias or migration.

**Browser.** Isolated127.0.0.1:5279 pre-repair draft reopens with9 Marines/240,
limit235 and5 over. C14 now shows12 inches; the literal player name and old copied
Raynor label persist, including another update/reopen. New Raynor faction choices,
configuration and saved name decode correctly. Category-qualified selection plus
the pinned ID test distinguishes the same-name Core unit. Marines retain
6/160 -> Shield6/180 -> Reinforce9/240 -> removal6/180. A second squad remains
6/160. Saved final9/240 +6/160 =400 with limit395 reopens5 over, with6 satisfied
structural and12 satisfied constraint bounds.

Freshlocalhost:5279 Browse loads Protoss with0 diagnostics. Daelaam +Sentries2/130
show full Restoration4-inch, GuardianShield4-inch and ForceField8-inch/it's text,
including after save/reopen. Repeat Browse reports warm metadata. Zerglings12/180
initialize; missing Faction and Core Supply problems persist. Normal four-file
local XML import has0 diagnostics, and the previously saved Protoss reopens its
own source context afterwards. Desktop1440x900 and phone390x844 screenshots were
inspected; Marine page width375/scrollWidth375, no page overflow. Viewport reset.
Print output was inspected in tests; live print invoked no controllable IAB output
tab, so no PDF/pagination claim. Leave5279 and old5277/5275/5273/5271 running.

**Review and validation.** A bounded native reviewer in the detached isolated
starcraft-uncertainty-xml-review worktree approved code, final tests and report.
The lead owned implementation/integration/browser/gates/docs/publication. Claude's
installed launcher was already unavailable; no retries, reinstall or external
review claim. Review challenged PI context, numeric failures, cache versions,
structural aliases and legacy budgets; valid range endpoints were added. Final
report wording corrections were applied.

Focused XML/draft tests:45 pass,2 files,1.11s. Final normal gates all pass:
919 tests passed,32 optional skips;89 passed/7 skipped files,11.82s. Build189 modules,
JS834.96kB/gzip231.15, CSS83.38kB/gzip14.87; existing chunk advisory only.
All seven configured integration files:32 pass,0 skips,38.50s (30 existing40k,
2 StarCraft). Initial concurrent run timed out the new full-source test at its
5-second default; matching the existing30-second corpus allowance passed with
assertions unchanged. Pricing, Supporting, initialization, budgets, persistence/
recovery, reference grouping, renderer timing, capacity, Dark Angels switching
and rule visibility remain covered. All StarCraft hashes,40k HEAD
04c62fcd041b3808c39d5c46fd677c704027b979 and correctness A/B manifests unchanged.

**Handoff and stop.** Architecture, compatibility, diagnostics and SC-05 report
updated. Historical baseline observations remain with a supersession note.
Publish only to pilot and confirm exact-final CI. Stop after these two checkpoints.
...
**Historical status:** the later owner-authorized pre-game A/B batch repairs the
dropped group requirements and evidenced modifier-ID visibility defect. Its entry
below supersedes the no-repair authorization boundary; counter/map blockers and
the original failed acceptance evidence remain valid.
...
publication. A `d62897995671c2eddf8731fff8e0baed5e962cd4`, B
`d28e3b7299236f46b4c7b6929cd4c25f2643b58f`, then this separate handoff.
Publish only pilot and verify CI for the exact final handoff commit in Actions;
local results below are not a claim that remote CI has already completed.

**A cause and decision.** `selectionBounds` discarded non-parent group bounds
before diagnosis. Flattened groups have no durable occurrence for general
validation to recover, so omitted requirements appeared complete/optional. Five
fictional pre-fix assertions failed; frozen maps/missions reproduced the omission.
Established static shared roster min/max with child inclusion uses the existing
source-path frontier membership helper, counts concrete member amounts across
shared instances, and excludes wrapper/parent amount multiplication and concrete
member descendants. Configuration and structural findings consume shared results;
retained-wrapper general reports are deduplicated by authored source identity.
No hard-coded names/IDs/two-choice rules. No arbitrary initialization defaults.
Unsupported requirements now qualify the owning group and aggregate completeness.

Independent review caught context-varying own limits coalesced across wrappers and
omitted distant selected-ancestor modifiers. The final boundary is static bounds
with no targeting own/selected-ancestor modifiers, one unnested force, unambiguous
source identity. Nonshared/traversal/mixed domains and unresolved group links remain
incomplete. This was chosen over pretending roster scope is per-parent, choosing
arbitrary defaults, or merely emitting warnings when exact supported counts exist.
A focused16 tests pass; independent32 tests across2 files overlap primary coverage.
40k Guardian Defenders now exposes nine previously dropped self-scope requirements
as diagnostics while preserving33 initialized additions/41 occurrences and exact
defaults. A final configured1122 pass, zero skips,108 files,41.41s; all gates pass.

**B cause and decision.** Only exact visibility-modifier `id` is recognized as
identity metadata; original projection/bytes stay intact. Source/editor evidence
supports the inert identity interpretation; no broad attribute-suffix exception.
Existing visibility evaluation handles the two missions' complete Minerals-limit
predicates. A shared app predicate excludes only complete known-hidden profiles
from ordinary unit/supplementary/print references. Raw inspection/technical details
retain records; uncertain profiles stay visible. No mission-name filter, guessed
budget, evaluator bypass or new rendering privilege. Seven fictional ingestion/API/
UI/HTML tests include linked/grouped visibility; frozen integration checks60 profile
observations across three factions and five limits. Existing target/carrier/routing,
reference fields, safe text and uncertainty coverage retained.

**Browser/lifecycle.** Lead used ordinary live pinned StarCraft acquisition on fresh
5299 and created SC Pregame - Khalai setup. Empty/partial/complete requirements,
actionable problem routing, disabled excess controls, remove/undo/redo and
save/reopen passed. No arbitrary map/mission autofill. Accepted samples copied with
separate IDs/names using production decoder/store on5299, then normal Open:
Protoss1220M/130G/limit1500, Terran570M/60G/limit600, Zerg520M/30G/limit600.
Pairs retained (ProtossAcropolis/Breach; Terran/ZergAbandonedCamp/AgriaValley;
allDivideAndConquer/Frontlines). Protoss999/1000 Skirmish,1001 Standard, reset2000,
restore1500/save/reopen Standard; spending stayed1220 and choices persisted.
Terran/Zerg showed two Skirmish profiles. Constructed incomplete legacy-format
Zerg copy (only map/mission children removed, fixture history cleared) reopened with
two missing requirements and unchanged520M/30G. No claim of finding an existing
owner incomplete draft. Phone390x844 and desktop1280x720 inspected. Terran actual
Compact HTML contains active profiles/all seven fields/P3/P4-to-U2 mapping; map
payload remains literal. No PDF or pagination claim. Full details in focused report.

**Review and final gates.** Native reviewer isolated at
C:/CodexACLTest/starcraft-pregame-review-20260925. Lead primary implementation;
reviewer challenged source identity/shared scope, unknown-vs-empty, deduplication,
modifier metadata and screen/print agreement. B final58 focused tests plus linked/
grouped challenge and20 frozen comparisons passed (overlap; not additive totals).
Final docs review corrected diagnostic name and overbroad attribute wording. One
sanitized tool-disabled Claude CLI attempt failed expired OAuth refresh before
inference; no repeated launcher retry, provider install/billing change or bypass.

Final normal1095 pass/35 opt-in skips,109 files,25.12s; configured1130 pass/zero
skips,109 files,44.69s. Lint/typecheck/build/diff-check passed; existing chunk-size
advisory only. Configured inputs (all vars prefixed ROSTERFORGE_): BSDATA_JSON_DIR
E:/GitHub/wh40k-11e; CORRECTNESS_SNAPSHOTS C:/CodexACLTest/rf-data-parity-evidence-20260910;
STARCRAFT_PILOT_DIR C:/CodexACLTest/starcraft-pilot-evidence/data; PRINT_DARK_ANGELS
C:/CodexACLTest/rf-cost-evidence-20260911/cost-reference-draft.json. No PRINT_OUTPUT.
Original file lengths/SHA-256 match all manifests: SC99261754 four XML plus README,
40k A04c62fcd eight files, B5b261ec eight files; JSON checkout HEAD remains A.
Final test logs C:/CodexACLTest/pregame-A-final-tests.log,
pregame-B-normal.log and pregame-B-final-configured.log. Configured coverage protects
pricing, initialization, budgets, Captain/rule labels, Supporting/effects, Marines,
faction/supply, history/recovery, XML safety/reference grouping and renderer timing.

**Retained output and stop.** Plain Vite5299 PID63336 and the five SC Pregame drafts
listed in Current Status remain for owner testing; original5297 PID56784 preserved.
No owner armies/storage/tabs/source bytes changed. Complete-army acceptance remains
B blocked: seven zero/hidden counter activations and map embedded-image policy need
separate assignments. Dynamic limits, multi-force semantics, imported formatting,
