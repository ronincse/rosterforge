...
export type RosterForceConstraintCostEvaluation = ScopedCostConstraintEvaluation<"selectionConditions">;
...
function evaluateForceConstraintCost(
  ...
  return queryCostConstraint(report, occurrences, typeId, costType);
}
